    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(br.com.semavize.pmm.precoPrazoSOAP.CalcPrecoPrazoWS.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.semavize.pmm.precoPrazoSOAP.CalcPrecoPrazoWS.class.getResource(".");
